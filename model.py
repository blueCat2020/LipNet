...
class LipNet(torch.nn.Module):
    def __init__(self,use_cuda=False,attention_size=1,dropout_rate=0.5):
        ...
        '''
        #[1,96,10,7,14]
        self.lstm1 = nn.LSTM(96*7*14, 256,bidirectional=True, batch_first=True)
        self.lstm2 = nn.LSTM(256*2, 256,bidirectional=True, batch_first=True)
